...
function preLoadPageToCurrentHash() {
	...
	if (typeof currentSearch.item !== "undefined") {
		...
		if (typeof searchResult !== "undefined") {
			...
			textMain += '<a href="http://complexshop.github.io" target="_blank"><span id="footerInfo">Complex 24 Shop &copy; 2017</span></a>';
			textMain += '<a href="https://www.inoreader.com/feed/http://feeds.feedburner.com/github/complexshop" target="_blank"><span id="footerRSS"></span></a>';
			textMain += '</div>';
			textMain += '</footer>';
			...
			textHTML += '		<meta name="google-site-verification" content="9BobPQ1ftOjAtfwYAsF01tvV9IAMgo-FagJDkZX_oaw" />\n';
			...
			textHTML += '		<title>Complex 24 Shop - Buy ' + searchResult.title + '</title>\n';
			textHTML += '		<meta name="description" content="' + searchResult.title + '" />\n';
			textHTML += '		<meta name="keywords" content="Complex 24 Shop, ' + searchResult.title.split("  ").join(" ").split(" ").join(", ") + '" />\n';
			textHTML += '		<meta property="og:type" content="product" />\n';
			textHTML += '		<meta property="og:title" content="Complex 24 Shop" />\n';
			...
			textHTML += '		<meta property="og:url" content="https://complexshop.github.io/#' + searchResult.search + '" />\n';
			textHTML += '		<meta name="twitter:card" content="summary_large_image" />\n';
			textHTML += '		<meta name="twitter:site" content="@complexshop01" />\n';
			textHTML += '		<link rel="canonical" href="https://complexshop.github.io/#' + searchResult.search + '" />\n';
			...
			textHTML += '		<meta name="apple-mobile-web-app-title" content="Complex 24 Shop" />\n';
			textHTML += '		<meta name="application-name" content="Complex 24 Shop" />\n';
			...
			textHTML += '		<link rel="alternate" type="application/rss+xml" title="RSS Feed for Complex 24 Shop" href="http://feeds.feedburner.com/github/complexshop" />\n';
			textHTML += '		<link rel="stylesheet" href="css/main.css" />\n';
			textHTML += '		<script>(function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,"script","https://www.google-analytics.com/analytics.js","ga");ga("create", "UA-93917692-1", "auto");ga("send", "pageview");</script>\n';
			textHTML += '	</head>\n';
			textHTML += '	<body>\n';
	...
	if (App.currentHash !== "") {
		...
		if (typeof searchResult !== "undefined") {
			...
			$("meta[name='keywords']").attr("content", "Complex 24 Shop, " + searchResult.title.split("  ").join(" ").split(" ").join(", "));
			...
			$("meta[property='og\\:url']").attr("content", "https://complexshop.github.io/#" + searchResult.search);
...
function getcomplexshopTwitterPage() {
	openURL("https://twitter.com/complexshop01");
}

function getcomplexshopPage() {
	openURL("https://goo.gl/vFftYE");
}

function getInfoPage() {
	openURL("http://complexshop.github.io");
}

function getRSSPage() {
	openURL("https://www.inoreader.com/feed/http://feeds.feedburner.com/github/complexshop");
}

function getcomplexshopTelegramPage() {
	openURL("http://telegram.me/complexshop01");
}
...
$(document).ready(function () {
	...
	textMain += '<span id="titlePage">Complex 24 Shop</span>';
	...
	textMain += '<footer>';
	textMain += '<div id="footerPage">';
	textMain += '<span id="footerInfo">Complex 24 Shop &copy; 2017</span>';
	...
	App.elementLogoImage.click(function () {
		getcomplexshopTwitterPage();
		my_ga('send', 'event', 'getcomplexshopTwitterPage', 'click', 'elementLogoImage');
	});

	App.elementTitlePage.click(function () {
		getcomplexshopPage();
		my_ga('send', 'event', 'getcomplexshopPage', 'click', 'elementTitlePage');
	});
